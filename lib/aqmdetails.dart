...
class MyAqmPage extends StatefulWidget{

  @override
  _MyAqmPageState createState() => _MyAqmPageState();

}


class _MyAqmPageState extends State<MyAqmPage> {
  TextEditingController channelID= new TextEditingController();
  TextEditingController apiKey= new TextEditingController();
  @override
  Widget build(BuildContext context) {
          ...
          child: MaterialButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                  builder: (context) =>
                   Extraction(channelId: channelID.text, apiKEY: apiKey.text, fromDate: _date1.text, toDate: _date2.text,)));
